...
export function MembersClientPage({
  ...
  // Convert searchParams to a stable string to use in effect deps
  ...
  // include searchParamsStr and currentPage to satisfy exhaustive-deps lint rule
  }, [debouncedSearchTerm, pathname, router, currentPage, searchParamsStr])
    ...
    <div>
      <div className="flex items-center gap-4 mb-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-slate-500">
            <DropdownMenuRadioGroup value={teamFilter} onValueChange={handleTeamFilterChange}>
              <DropdownMenuRadioItem value="">Tüm Takımlar</DropdownMenuRadioItem>
              <DropdownMenuSeparator />
              {allTeams.map((team) => (
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-lg">
        ...
        {initialParticipants.length === 0 && (
          <p className="text-center text-gray-400 p-8">Bu kriterlere uygun katılımcı bulunamadı.</p>
        )}
      </div>
