...
import BecomeASponsorForm from "./BecomeASponsorForm";
...
export default function BecomeASponsorHero() {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col md:flex-row text-center overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <Link href="#why">Topluluğa Katıl</Link>
          </Button>
          <Button
            size="lg"
            variant="outline"
