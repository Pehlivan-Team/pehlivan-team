...
import pehli1 from '@public/Pehli1AI.png'
              ...
              <CarouselItem key={index}>
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="space-y-4 lg:row-start-1 row-start-2">
                    ...
                    <h3 className="text-4xl lg:text-5xl font-bold">{project.name}</h3>
                    <p className="text-lg">
                      Takım Lideri: <b>{project.leader}</b>
                    </p>
                    <p className="text-gray-200 leading-relaxed pt-2">{project.description}</p>

                    {/* -- SPECIFICATIONS SECTION -- */}
                    <div className="pt-4 mt-4 border-t border-white/20">
                      <h4 className="text-xl font-semibold mb-4">Teknik Özellikler</h4>
                      <motion.div
